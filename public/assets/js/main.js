    ...
    function navbarHandler() {
        ...
        main_menu.forEach(function (menu) {
            menu.addEventListener("click", function (e) {
                ...
                const activeMain =
                    menu.parentElement.classList.contains("open");
                ...
                for (let index = 0; index < subMenu.length; index++) {
                    ...
                    element.addEventListener("click", function (e) {
                        ...
                        // remove active class
                        const liActive = document.querySelectorAll(
                            "nav ul ul li.active"
                        );
        ...
        document.querySelectorAll(".action-toggle").forEach((elem) => {
            elem.addEventListener("click", function (e) {
                ...
                if (
                    ...
                    document
                        .querySelector("body")
                        .classList.remove("collapse-sidebar");
                } else {
                    document
                        .querySelector("body")
                    ...
                    document
                        .querySelector("body")
                        .classList.add("collapse-sidebar");
                }
            });
        });
    }
